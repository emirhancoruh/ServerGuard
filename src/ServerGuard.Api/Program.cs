...
// Acilis log'u. Uygulama daha kurulmadan hata verebilir - eksik baglanti dizesi, eksik
// guvenlik ayari, bozuk appsettings. O noktada henuz DI ve asil logger yoktur; bu kayit
// olmazsa hata yalnizca konsola yazilir ve IIS altinda konsol hicbir yere gitmez.
// Sonuc: en cok ihtiyac duyulan mesaj tam da goremeyecegimiz yerde kalir.
Log.Logger = new LoggerConfiguration()
    .WriteTo.Console()
    .WriteTo.WriteToRollingFile(AppContext.BaseDirectory)
...
{
    Log.Fatal(exception, "Uygulama acilamadi.");

    // Yeniden firlatilir: IIS'in 500.30 gostermesi ve surecin basarisiz sayilmasi gerekir.
    // Sessizce cikmak, sitenin calisiyor gorunmesine yol acardi.
    throw;
}
finally
{
